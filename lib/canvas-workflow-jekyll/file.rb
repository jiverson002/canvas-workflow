    ...
    module Jekyll
      class FileTag < Liquid::Tag
        ...
        def render(context)
          ...
          # patch incorrect implementations
          client.define_singleton_method(:resolve_path_courses) do |course_id, path, opts={}|
            query_param_keys = [
            ]
            ...
            Pandarus::RemoteCollection.new(connection, Pandarus::Folder, path, query_params)
          end
